...
const reviews = [
    {
        name: 'Emily Thompson',
        role: 'Patient',
        content: 'The diagnostics at Dwarika Hospital are world-class. The automated lab provided results within hours, helping my doctor start the treatment immediately.',
        rating: 5,
    },
    {
        name: 'James Rodriguez',
        role: 'Patient',
        content: 'I highly recommend their academic wing. The level of professionalism shown by both senior consultants and residents is commendable.',
        rating: 5,
    },
    {
        name: 'Sarah Parker',
        role: 'Guardian',
        content: 'The pediatric surgery team handled my daughter\'s case with such care and precision. We are grateful for the specialized attention we received.',
        rating: 5,
    },
];
