...
const getDepartments = (t: any) => [
  ...
  {
    icon: Scissors,
    title: t('departments.list.surgery.title'),
    slug: "surgery",
    desc: t('departments.list.surgery.desc'),
    color: "bg-indigo-50",
  ...
  {
    icon: Ear,
    title: t('departments.list.ent.title'),
    slug: "ent",
    desc: t('departments.list.ent.desc'),
    color: "bg-orange-50",
  ...
  {
    icon: Smile,
    title: t('departments.list.dental.title'),
    slug: "dental",
    desc: t('departments.list.dental.desc'),
    color: "bg-cyan-50",
  ...
  {
    icon: Sparkles,
    title: t('departments.list.dermatology.title'),
    slug: "dermatology",
    desc: t('departments.list.dermatology.desc'),
    color: "bg-emerald-50",
  ...
  {
    icon: Brain,
    title: t('departments.list.psychiatry.title'),
    slug: "psychiatry",
    desc: t('departments.list.psychiatry.desc'),
    color: "bg-violet-50",
